...
public class Lesson1 {
    ...
    public static void init(){
        ...
        darkSide.add(new Witch(darkSide, x++, y));
        Random rnd = new Random();
        for (int i = 0; i < 6; i++) {
            switch (rnd.nextInt(4)) {
                case 0 -> darkSide.add(new Peasant(darkSide, x++, y));
                case 1 -> darkSide.add(new Robber(darkSide, x++, y));
                case 2 -> darkSide.add(new Sniper(darkSide, x++, y));
                default -> darkSide.add(new Witch(darkSide, x++, y));
            }
        }
        ...
        for (int i = 0; i < 6; i++) {
            switch (rnd.nextInt(4)) {
                ...
                case 1 -> whiteSide.add(new Monk(whiteSide, x++, y));
                case 2 -> whiteSide.add(new Crossbowman(whiteSide, x++, y));
                default -> whiteSide.add(new Spearman(whiteSide, x++, y));
            }
        }
